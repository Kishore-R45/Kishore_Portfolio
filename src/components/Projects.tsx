  ...
  const projects = [
    {
      ...
      description: "Flutter mobile app with secure biometric auth, offline data access, sentence transformers embeddings, semantic search, OCR extraction, real-time AI chat, and expiry reminder notifications.",
      image: "/assets/Projects/infovault.png",
      technologies: [" Flutter", "Flask", "MongoDB", "Pinecone", "Sentence-Transformers", "HuggingFace LLM", "Firebase FCM"],
      github: "https://github.com/Kishore-R45/AI-Powered-Document-Intelligence-System",
      demo: "https://github.com/Kishore-R45/AI-Powered-Document-Intelligence-System/tree/main/latest-apk-release"
    },
    {
